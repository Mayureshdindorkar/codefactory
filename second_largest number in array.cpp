<!DOCTYPE html>
<!-- saved from url=(0067)https://www.hackerrank.com/contests/se-a-14-october-2018/challenges -->
<html lang="en" class=" mod_js mod_flexbox mod_flexboxlegacy mod_canvas mod_canvastext mod_webgl mod_no-touch mod_geolocation mod_history mod_draganddrop mod_rgba mod_hsla mod_multiplebgs mod_backgroundsize mod_borderimage mod_borderradius mod_boxshadow mod_textshadow mod_opacity mod_cssanimations mod_csscolumns mod_cssgradients mod_cssreflections mod_csstransforms mod_csstransforms3d mod_csstransitions mod_fontface mod_no-generatedcontent mod_video mod_audio mod_applicationcache mod_svg mod_inlinesvg mod_smil mod_svgclippaths mod_csscalc mod_fullscreen mod_cssresize mod_no-ie8compat"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <script type="text/javascript" async="" src="./second_largest number in array_files/BizibleAcct.js.download"></script><script type="text/javascript" src="./second_largest number in array_files/46ce49ae81"></script><script id="twitter-wjs" src="https://platform.twitter.com/widgets.js"></script><script src="./second_largest number in array_files/bizible.js.download"></script><script type="text/javascript" async="" src="./second_largest number in array_files/filepicker.js.download"></script><script type="text/javascript" async="" src="./second_largest number in array_files/mixpanel-2.2.min.js.download"></script><script type="text/javascript" async="" src="./second_largest number in array_files/ga.js.download"></script><script src="./second_largest number in array_files/nr-1099.min.js.download"></script><script type="text/javascript">
...
</script><script src="./second_largest number in array_files/cdnping-e4dfec54a83d6e6bc9baf3ce741ae25e.js.download"></script><script>checkForWorkingCDN();</script>
...
<link href="https://www.hackerrank.com/contests/se-a-14-october-2018/challenges/the-second-/" rel="canonical"><!-- ends meta tags generation -->

<!-- CSRF Token -->
<meta name="csrf-param" content="authenticity_token">
<meta name="csrf-token" content="p/VjNA4MQ27RWIdbrgkICSYJREbOwd1l31Hr/UPKxUiCatCI+HijbpCL+0+Mg6qW/IFM+c7agom/Bed8meDcOA==">

  <link rel="stylesheet" media="all" href="./second_largest number in array_files/hackerrank_libraries-21fce5f00a5704ab97ea6e29f618ca7f.css">
  <link rel="stylesheet" media="all" href="./second_largest number in array_files/hackerrank-core2-01b74a91b4f9ef6a546d4c6e82f7d071.css">
  <link rel="stylesheet" media="all" href="./second_largest number in array_files/dashboard-2f9150980242ec5cfe8eab05dfd8a3be.css">
  <link rel="stylesheet" media="all" href="./second_largest number in array_files/theme_m_patch-98ffc64b071b197b5010bc9e51c4ade7.css">
...
-->
  <script src="./second_largest number in array_files/raven-842e0dd9ae7063befec00a4841fc2792.js.download" id="raven" crossorigin="anonymous" async="async"></script>
  <script type="text/javascript">
...
<script type="text/template" id="nav-buttons">
    ...
    <div id="wrapper" class="theme-m-content" style="min-height: 599px;">
        <div id="navigation">
        ...
        <ul class="nav-links">
            <li class="nav-link-item logo-wrap">
                <a href="https://www.hackerrank.com/dashboard?h_r=logo" class="nav_link backbone logo_mark js_logo_mark logo-link" data-analytics="NavBarLogo"><img id="feed-intro" class="logo-img-small" src="./second_largest number in array_files/h_mark_sm-9c05999c62674028552f4e813728e591.svg" alt=""></a>
            </li>
            <li class="nav-link-item">
    ...
    <div class="hide-in-private-contest search-result hide" style="display: block;">
                ...
                <li class="dropdown-auth">
                    <div class="dropdown theme-m-content profile-menu-item" id="profile-menu">
                        <a class="backbone nav_link dropdown-toggle" href="https://www.hackerrank.com/" data-toggle="dropdown" data-analytics="NavBarProfileDropDown">
                            <img src="./second_largest number in array_files/150x150.png" alt="" class="avatar" onerror="this.onerror=null; this.src=&#39;https://d3rpyts3de3lx8.cloudfront.net/hackerrank/assets/gravatar.jpg&#39;;">
                            <span class="mmR profile-username">dmayuresh99</span>
                            <i class="icon-down-open"></i>
                        </a>
                        <div class="dropdown-menu drop-list pull-right">
                            <ul>
                                <li class="hide-in-private-contest profile-nav-item"><a class="navigation_hackos hackos-count backbone" href="https://www.hackerrank.com/dmayuresh99/hackos" data-analytics="NavBarProfileDropDownHackos">Hackos: <span class="navigation_hackos-count">257</span></a></li>
                                <li class="hide-in-private-contest profile-nav-item">
        ...
        <div id="ajax-msg-wrap"><div id="ajax-msg" style="margin-left: -35.5px; display: block;"><span class="ajax-loader"></span><span class="ajax-msg">Loading...</span></div></div>
    ...
    <div class="content-header">
        ...
        <div id="content" class="main_content"><div class="loading-view"><div class="gray"> <div class="hackerrank-spinner" style="height: 64px; width: 64px;"></div> </div></div></div>
        <div id="hacker"></div>
    </div>
    <div id="autocomplete-container" style="position:absolute; width: 330px; z-index: 2000; padding-top: 1px;"><ul class="ui-autocomplete ui-front ui-menu ui-widget ui-widget-content theme-m-content" id="ui-id-20" tabindex="0" style="display: none;"></ul></div>
...
;
    ...
    <!-- Load Jquery -->
  <script src="./second_largest number in array_files/base-4e953f9582ddc0e62ee5b02dbe2520ca.js.download"></script>



    <script src="./second_largest number in array_files/hackerrank_libraries-b21aac6bd2dca1aed1bb43de5add4427.js.download" crossorigin="anonymous"></script>
    <script src="./second_largest number in array_files/codeshell-cdffcdf1564c6416e1a2eb207a4521ce.js.download" crossorigin="anonymous"></script>
    <script src="./second_largest number in array_files/hackerrank-9bd5f511d44951860f482b65a3569a9c.js.download" crossorigin="anonymous"></script>
    <script src="./second_largest number in array_files/set-manifest-85f67987739802a3c3cd88f1727c69f2e1d81c56.js.download" crossorigin="anonymous"></script>
    <script src="./second_largest number in array_files/require-76e24a0ace8716757c96e986f7dc9e07.js.download" crossorigin="anonymous"></script>
    <script src="./second_largest number in array_files/dashboard-183d9c4c0e5680a01b67b78570aa29f6.js.download" crossorigin="anonymous"></script>
...
<div class="offline-ui offline-ui-up"><div class="offline-ui-content"></div><a href="https://www.hackerrank.com/" class="offline-ui-retry"></a></div><div class="offline-ui offline-ui-up"><div class="offline-ui-content"></div><a href="https://www.hackerrank.com/" class="offline-ui-retry"></a></div><iframe name="filepicker_comm_iframe" id="filepicker_comm_iframe" src="./second_largest number in array_files/saved_resource.html" style="display: none;"></iframe><iframe name="fpapi_comm_iframe" id="fpapi_comm_iframe" src="./second_largest number in array_files/saved_resource(1).html" style="display: none;"></iframe><img src="./second_largest number in array_files/ipv" style="display: none;"><img src="./second_largest number in array_files/ipv(1)" style="display: none;"><img src="./second_largest number in array_files/ipv(2)" style="display: none;"><link rel="stylesheet" href="./second_largest number in array_files/animate-702952f12d9729d5ba7d2be8fc590d83.css" media="all"><img src="./second_largest number in array_files/ipv(3)" style="display: none;"><span role="status" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></span></body></html>